🩺 **COO Fleet Health** — last check 2026-05-28T11:18:18.717Z

**13** scheduled routines · **8** healthy · **5** unhealthy · **5** escalated

| repo | routine | status | last run | action |
|---|---|---|---|---|
| beyond-elevation | LinkedIn Carousel Pipeline (Daily Queue) | ❌ FAILING | 4.4h ago | ESCALATED (3 heals failed) |
| beyond-elevation | LinkedIn Carousel Posts (5× Daily) | ❌ FAILING | 27.0d ago | ESCALATED (3 heals failed) |
| beyond-elevation | LinkedIn Content Pipeline (Daily Queue) | ❌ FAILING | 3.6h ago | ESCALATED (3 heals failed) |
...
| coo-prime-private | coo-cross-repo-watchdog | ✅ HEALTHY | 23.5h ago | — |
| coo-prime-private | coo-scheduler-watchdog | ✅ HEALTHY | 2.8h ago | — |
| coo-prime-private | coo-scheduler | ✅ HEALTHY | 2.8h ago | — |
| patent-ceo-cron | Weekly Patent-CEO Sheet | ✅ HEALTHY | 6.9h ago | — |
| top11 | Review Pulse — nightly refresh | ✅ HEALTHY | 4.2h ago | — |
...
- **horror5how/instagram-autopilot** → autopilot-hourly: FAILING after 3 auto-heals. job "run" step "Run autopilot (one hourly slot)". https://github.com/horror5how/instagram-autopilot/actions/runs/26568913079
