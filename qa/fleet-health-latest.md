🩺 **COO Fleet Health** — last check 2026-06-12T13:35:51.867Z

**15** scheduled routines · **10** healthy · **5** unhealthy · **5** escalated

| repo | routine | status | last run | action |
|---|---|---|---|---|
| beyond-elevation | Daily Blog Draft Review Digest | 🕒 STALLED | 6.0d ago | ESCALATED (3 heals failed) |
| getinpositions | Blog Content Engine | ❌ FAILING | 2.6d ago | ESCALATED (3 heals failed) |
| instagram-autopilot | autopilot-hourly | ❌ FAILING | 39.7h ago | ESCALATED (3 heals failed) |
| patent-ceo-cron | Weekly Patent-CEO Sheet | 🕒 STALLED | 15.4d ago | ESCALATED (3 heals failed) |
| patent-ceo-cron | Patent CEO Daily Pusher | 🗑️ WORKFLOW_MISSING | 18.1d ago | workflow file deleted — restore required (cannot auto-dispatch) |
| beyond-elevation | Daily AI & GitHub Digest Email | ✅ HEALTHY | 2.7h ago | — |
...
| top11 | CEO daily — Top Eleven growth loop | ✅ HEALTHY | 1.9h ago | — |
| top11 | List factory (autonomous) | ✅ HEALTHY | 1.7h ago | — |
| top11 | Review Pulse — nightly refresh | ✅ HEALTHY | 5.5h ago | — |
| top11 | Syndicate to Dev.to | ✅ HEALTHY | 2.8h ago | — |
