🩺 **COO Fleet Health** — last check 2026-06-02T10:08:18.024Z

**15** scheduled routines · **7** healthy · **8** unhealthy · **7** escalated

| repo | routine | status | last run | action |
|---|---|---|---|---|
| beyond-elevation | Daily Blog Draft Review Digest | ❌ FAILING | 15.6h ago | ESCALATED (3 heals failed) |
| beyond-elevation | LinkedIn Carousel Pipeline (Daily Queue) | ❌ FAILING | 2.8h ago | ESCALATED (3 heals failed) |
| beyond-elevation | LinkedIn Carousel Posts (5× Daily) | ❌ FAILING | 31.9d ago | ESCALATED (3 heals failed) |
| beyond-elevation | LinkedIn Content Pipeline (Daily Queue) | ❌ FAILING | 1.8h ago | healing via rerun-failed-jobs |
| instagram-autopilot | autopilot-hourly | ❌ FAILING | 11.6h ago | ESCALATED (3 heals failed) |
| patent-ceo-cron | Weekly Patent-CEO Sheet | 🕒 STALLED | 5.2d ago | ESCALATED (3 heals failed) |
| patent-ceo-cron | Patent CEO Daily Pusher | 🗑️ WORKFLOW_MISSING | 7.9d ago | workflow file deleted — restore required (cannot auto-dispatch) |
| top11 | .github/workflows/list-factory.yml | ❌ FAILING | 47.9h ago | ESCALATED (3 heals failed) |
| beyond-elevation | Daily AI & GitHub Digest Email | ✅ HEALTHY | 21.7h ago | — |
| beyond-elevation | LinkedIn Scheduled Posts (5× Daily) | ✅ HEALTHY | 13.3h ago | — |
| coo-prime-private | coo-cross-repo-watchdog | ✅ HEALTHY | 20.4h ago | — |
| coo-prime-private | coo-scheduler-watchdog | ✅ HEALTHY | 3.8h ago | — |
| coo-prime-private | coo-scheduler | ✅ HEALTHY | 3.3h ago | — |
| top11 | Review Pulse — nightly refresh | ✅ HEALTHY | 1.9h ago | — |
| top11 | Weekly index audit | ✅ HEALTHY | 19.2h ago | — |
