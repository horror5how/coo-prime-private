🩺 **COO Fleet Health** — last check 2026-06-06T16:03:20.877Z

**16** scheduled routines · **4** healthy · **12** unhealthy · **7** escalated

| repo | routine | status | last run | action |
|---|---|---|---|---|
| beyond-elevation | LinkedIn Content Pipeline (Daily Queue) | ❌ FAILING | 9.3h ago | ESCALATED (3 heals failed) |
| beyond-elevation | LinkedIn Carousel Pipeline (Daily Queue) | ❌ FAILING | 9.6h ago | ESCALATED (3 heals failed) |
| beyond-elevation | LinkedIn Carousel Posts (5× Daily) | ❌ FAILING | 36.2d ago | ESCALATED (3 heals failed) |
| beyond-elevation | Daily Blog Draft Review Digest | ❌ FAILING | 1.3h ago | healing via rerun-failed-jobs |
| coo-prime-private | coo-cross-repo-watchdog | ❌ FAILING | 4.1h ago | healing via rerun-failed-jobs |
| coo-prime-private | coo-scheduler-watchdog | ❌ FAILING | 0.7h ago | healing via rerun-failed-jobs |
| coo-prime-private | coo-scheduler | ❌ FAILING | 0.4h ago | healing via rerun-failed-jobs |
...
| top11 | List factory (autonomous) | ❌ FAILING | 1.9h ago | ESCALATED (3 heals failed) |
| top11 | Review Pulse — nightly refresh | ❌ FAILING | 9.4h ago | healing via rerun-failed-jobs |
| beyond-elevation | Daily AI & GitHub Digest Email | ✅ HEALTHY | 6.8h ago | — |
...
| top11 | Weekly index audit | ✅ HEALTHY | 28.4h ago | — |
